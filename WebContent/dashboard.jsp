...
<head>
<meta charset="utf-8" />
<title>Administration- Dashboard - CamerShop</title>
<meta content="width=device-width, initial-scale=1.0" name="viewport" />
<meta content="" name="site ecommerce camershop" />
<meta content="" name="Camel Adrienne Legrand Franck" />
<link
					...
					<ul class="nav pull-right top-menu">
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown"> <img width="20" height="20"
								src="./images/<%=utilisateur.getPhoto()%>" alt=""> <span
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							CamerShop<small> Dashboard</small>
						</h3>
						<ul class="breadcrumb">
								...
								<table class="table table-striped table-bordered" id="sample_1">
									<thead>
										<tr>
											...
											<th class="hidden-phone text-danger">TOTAL COMMANDES</th>
											<th class="hidden-phone">TOTAL CLIENTS</th>
											<th class="hidden-phone">TOTAL VENTES</th>
											<th class="hidden-phone">COMMANDE EN COURS...</th>
										</tr>
									</thead>
									<tbody>
										<tr>
