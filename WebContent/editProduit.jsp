...
<head>
<meta charset="utf-8" />
<title>Modification d'un Article - Camershop</title>
					...
					<ul class="nav pull-right top-menu">
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown"> <img width="20" height="20"
								src="./images/<%=utilisateur.getPhoto()%>" alt="">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							CamerShop <small>Modification d'un Article</small>
						</h3>
						<ul class="breadcrumb">
									...
									<table class="table">
										<tr>
											...
											<td><input class="form-control form-control-lg"
												type="text" name="idArticle" value="<%=u.getIdArticle()%>"></td>
										</tr>
										<tr>
											<td>Nom Article:</td>
											<td><input class="form-control form-control-lg"
												type="text" name="designation"
												value="<%=u.getDesignation()%>"></td>
										</tr>
										...
										<tr>
											...
											<td><input class="form-control form-control-lg"
												...
												value="<%=u.getDescription()%>" /></td>
										</tr>

										<tr>
											<td>Prix:</td>
											<td><input class="form-control form-control-lg"
												type="text" name="prix" value="<%=u.getPrix()%>"></td>
										</tr>

										<tr>
											<td>Quantité:</td>
											<td><input class="form-control form-control-lg"
												type="text" name="quantite" value="<%=u.getQuantite()%>"></td>
										</tr>

										<tr>
											<td>Categorie:</td>
											<td><select name="categorie">
													<option value="1" default>TELEVISION</option>
													<option value="2">AUDIO & HIFI</option>
													<option value="3">APPAREIL PHOTO & CAMERA</option>
													<option value="4">TELEPHONES PORTABLE</option>
													<option value="5">TABLETES</option>
													<option value="6">ACCESSOIRES TELEPHONIES</option>
													<option value="7">ORDINATEURS</option>
													<option value="10">LOGICIEL</option>
													<option value="11">EPICERIE</option>
													<option value="15">MODE HOME</option>
													<option value="16">MODE FEMME</option>
													<option value="18">PARFUMS</option>
											</select></td>
										</tr>
										...
										<tr>
											<td>Image Article:</td>
											<td><input class="form-control form-control-lg"
												type="text" name="image" value=./images/"<%=u.getImage()%>"></td>
										</tr>

										<tr>
											<td></td>
											<td><input class="form-control form-control-lg"
												class="btn btn-warning" type="submit" value="Ajouter">
												<input class="form-control form-control-lg"
												class="btn btn-inverse" type="reset" value="Effacer"></td>
										</tr>
