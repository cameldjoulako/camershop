...
<head>
<meta charset="utf-8" />
<title>Mise à jour d'informations - Camershop</title>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							CamerShop <small>Modification d'informations</small>
						</h3>
						<ul class="breadcrumb">
							...
							<li><a href="#">Modification d'informations</a><span
