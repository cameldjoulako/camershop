				...
				<div id="aside" class="col-md-3">
					...
					<div class="aside">
						...
						<ul class="filter-list">
							...
							<li><a href="#">MIN: 20.00 F CFA</a></li>
							<li><a href="#">MAX: 120.00 F CFA</a></li>
						</ul>
					...
					<div class="aside">
						...
						<div class="product product-widget">
							...
							<div class="product-body">
								<h2 class="product-name"><a href="#">Product Name Goes Here</a></h2>
								<h3 class="product-price">32.50 F CFA</h3>
								<div class="product-rating">
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
						...
						<div class="row">
							...
							<div class="col-md-4 col-sm-6 col-xs-6">
								<div class="product product-single">
									...
									<div class="product-body">
										<h3 class="product-price">32.50 F CFA <del class="product-old-price">45.00 F CFA</del></h3>
										<div class="product-rating">
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
							...
							<div class="col-md-4 col-sm-6 col-xs-6">
								<div class="product product-single">
									...
									<div class="product-body">
										<h3 class="product-price">32.50 F CFA <del class="product-old-price">$45.00</del></h3>
										<div class="product-rating">
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
