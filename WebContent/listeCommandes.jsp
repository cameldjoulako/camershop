...
<head>
<meta charset="utf-8" />
<title>Liste des Commandes - CamerShop</title>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<h3 class="page-title">
							CamerShop<small> Liste des Commandes</small>
						</h3>
						<ul class="breadcrumb">
					...
					<div class="span12">
						...
						<div class="widget">
							<div class="widget-title">
								<h4>
									<i class="icon-reorder"></i>Liste des Commandes
								</h4>
							...
							<div class="widget-body">
								...
								<table class="table table-striped table-bordered" id="sample_1">
									<thead>
										<tr>
											...
											<th class="hidden-phone">IdCommande</th>
											<th class="hidden-phone">IDUser</th>
											<th class="hidden-phone">EtatCommande</th>
									...
									<tbody>
										...
										<tr>
											...
											<td><a
												href="Produit?id=<%=commande.getIdCommande()%>&action=show"><%=commande.getIdCommande()%></a></td>
											<td><%=commande.getIdUser()%></td>
											<td><%=commande.getEtatCmde()%></td>
											<td><%=commande.getTotale()%></td>


											<td><a
												href="Commande?id=<%=commande.getIdCommande()%>&action=livrer">
													<input class="btn btn-success" type="button" value="Livrer">
											</a> <a
												href="Commande?id=<%=commande.getIdCommande()%>&action=delete">
													<input class="btn btn-danger" type="button"
													value="Supprimer">
											</a>
											<a
												href="Commande?id=<%=commande.getIdCommande()%>&action=edit">
								...
								<a href="AjoutCommande"> <input class="btn btn-primary"
									type="button" value="Ajouter une commande">
								</a>
							</div>
						</div>
